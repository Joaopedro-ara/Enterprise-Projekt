...
class produktion:
    ...
    def Maschine_anlegen(self,maschinen_id,bezeichnung,kategorie,baujahr,Anschafungskosten,restwert,Letze_warnung,naechste_wartung,Produktions_ort,
                         halle,status):
        ...
        if self.Produktions_Masch_pruefen(maschinen_id): # prüfen ob Artikel schon existirt
            ...
            sql=("Insert into prod_Maschinen(Maschinen_id,Bezeichnung,Kategorie,Baujahr,Anschaffungskosten,Restwert,"
                 "Letze_Wartung,Naechste_wartung,Produktions_Ort,Halle,Status) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)")
            values=(maschinen_id,bezeichnung,kategorie,baujahr,Anschafungskosten,restwert,Letze_warnung,naechste_wartung,Produktions_ort,
                         halle,status)
